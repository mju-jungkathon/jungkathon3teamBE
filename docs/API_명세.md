...
| 코드 | HTTP Status | 설명 |
| --- | --- | --- |
| E4001 | 400 | 요청 값 검증 실패 |
| E4010 | 401 | 인증 토큰 없음/만료 |
| E4030 | 403 | 권한 없음 (예: 카메라/위치 권한 미허용 상태에서 측정 요청) |
| E4040 | 404 | 리소스 없음 (세션/측정 기록 없음) |
| E4090 | 409 | 이미 진행 중인 러닝 세션 존재 |
| E5000 | 500 | 서버 오류 |
| E5010 | 502 | 애플 헬스 연동 실패 |
...
```json
{ "userId": "uuid", "email": "you@example.com", "nickname": "김러너", "createdAt": "2026-08-04T09:00:00+09:00" }
```
