...
public class GoalUpdateDto {
    ...
    /**
     * R7 §7.3 PATCH /users/me/goal 요청. 부분 수정이라 두 필드 모두 nullable.
    ...
    /** R7 §7.2 GET /users/me/goal 응답이기도 하다 — 두 엔드포인트가 같은 형태를 쓴다. */
    @Schema(name = "GoalUpdateResponse")
